    ...
    >
      <ItemConfigurationClient
        ...
        copy={{
          ...
          kindNewButton: t("section.kind.newKindButton"),
          kindNewNameLabel: t("section.kind.newNameLabel"),
          kindNewDisplayNameLabel: t("section.kind.newDisplayNameLabel"),
          kindCreateSubmit: t("section.kind.createKind"),
          kindCreateCancel: t("section.kind.cancelNewKind"),
