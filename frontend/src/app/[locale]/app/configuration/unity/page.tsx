    ...
    >
      <UnityConfigurationClient
        ...
        copy={{
          ...
          initialAgeLabel: t("section.age.initialLabel"),
          finalAgeLabel: t("section.age.finalLabel"),
          ageHint: t("section.age.hint"),
          validationItem: t("error.validationItem"),
          validationAge: t("error.validationAge"),
          validationAgeRequired: t("error.validationAgeRequired"),
