...
export default async function EventStandardConfigurationPage({
  ...
  return (
    ...
    >
      <EventStandardConfigurationData
        locale={locale}
        labelLang={labelLang}
        basePath={basePath}
...
type EventStandardConfigurationDataProps = {
  locale: string;
  labelLang: LabelLang;
  basePath: string;
...
async function EventStandardConfigurationData({
  locale,
  labelLang,
  basePath,
  currentScope,
  hasAnyScope,
  copy
}: EventStandardConfigurationDataProps) {
